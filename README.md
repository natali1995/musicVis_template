...
* correct mouse and keyboard interaction as specified by the instructions
* if the spectrogram is correctly drawn horizontally with colour change
* if the four needles plots are drawn and re-scale with the screen
